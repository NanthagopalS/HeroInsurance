namespace Insurance.Domain.Reliance.ProposalTaxListResponse;
...
{
    public List<TaxComponent> TaxComponent { get; set; }
...
public class MotorPolicy
{
    ...
    public List<LstPricingResponse> lstPricingResponse { get; set; }
    public string EndorsementNo { get; set; }
    public string QuoteNo { get; set; }
}

public class RelianceTaxListResponseDto
{
