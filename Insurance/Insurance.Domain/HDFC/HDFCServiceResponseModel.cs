...
namespace Insurance.Domain.HDFC
{
    ...
    public class HDFCServiceResponseModel
    {
        ...
        public Resp_Customer_Details Customer_Details { get; set; }
        public Resp_Policy_Details Policy_Details { get; set; }
        public Resp_Payment_Details Payment_Details { get; set; }
        public Resp_GCV Resp_GCV { get; set; }
        public Resp_MISD Resp_MISD { get; set; }
        public Resp_PCV Resp_PCV { get; set; }
        ...
        public Resp_TW Resp_TW { get; set; }
        ...
        public Resp_Pvtcar Resp_PvtCar { get; set; }
    ...
    public class Resp_Customer_Details
    {
    ...
    public class Resp_Policy_Details
    {
    ...
    public class Resp_PCV
    {
        ...
        public double GeogExtension_TPPremium { get; set; }
        public double PAOwnerDriver_Premium { get; set; }
        public double NumberOfDrivers_Premium { get; set; }
        public double NumberOfEmployees_Premium { get; set; }
        public double PAPaidDriverCleaCondCool_Premium { get; set; }
        public double BiFuel_Kit_OD_Premium { get; set; }
        public double BiFuel_Kit_TP_Premium { get; set; }
        public double Basic_TP_Premium { get; set; }
        public double Basic_OD_Premium { get; set; }
        ...
        public double LimitedtoOwnPremises_OD_Premium { get; set; }
        public double LimitedtoOwnPremises_TP_Premium { get; set; }
        public double PrivateUse_OD_Premium { get; set; }
        public double PrivateUse_TP_Premium { get; set; }
        public double VB_InclusionofIMT23_Premium { get; set; }
        public double Elec_InclusionofIMT23_Premium { get; set; }
        public double NonElec_InclusionofIMT23_Premium { get; set; }
        public double BiFuel_InclusionofIMT23_Premium { get; set; }
        public double OtherLoading_Premium { get; set; }
        public double OtherDiscount_Premium { get; set; }
        public double AntiTheftDisc_Premium { get; set; }
        public double HandicapDisc_Premium { get; set; }
        public double NCBBonusDisc_Premium { get; set; }
        public double FPP_Premium { get; set; }
        public double NFPP_Premium { get; set; }
        public double Vehicle_Base_COC_Premium { get; set; }
        public double Elec_COC_Premium { get; set; }
        public double NonElec_COC_Premium { get; set; }
        public double Bifuel_COC_Premium { get; set; }
        ...
        public double UTGST_Premium { get; set; }
        public double KeralaFloodCess_Premium { get; set; }
        public double SGST_Premium_TP { get; set; }
        public double CGST_Premium_TP { get; set; }
        public double IGST_Premium_TP { get; set; }
        public double SGST_Premium_OD { get; set; }
        public double CGST_Premium_OD { get; set; }
        public double IGST_Premium_OD { get; set; }
        public double IMT35_Premium { get; set; }
        public double Fibretank_Premium { get; set; }
        public double Workmen_Premium { get; set; }
        public double HighProtection_Premium { get; set; }
        public double Other_Discount { get; set; }
        public double Current_NCB_Per { get; set; }
        public double Tariff_Rate_Per { get; set; }
        public double EMI_PROTECTOR_PREMIUM_Rate { get; set; }
        public double Vehicle_Base_ZD_Premium_Rate { get; set; }
        public double Vehicle_Base_RTI_Premium_Rate { get; set; }
        public double Vehicle_Base_COC_Premium_Rate { get; set; }
        public double Vehicle_Base_ENG_Premium_Rate { get; set; }
        public double Vehicle_Base_NCB_Premium_Rate { get; set; }
        public double Towing_premium_Rate { get; set; }
        public double EA_premium_Rate { get; set; }
        public double EAW_premium_Rate { get; set; }
        public double HighProtection_Premium_Rate { get; set; }
    }

    public class Resp_GCV
    {
        public double IDV { get; set; }
        public double Net_Premium { get; set; }
        public double Service_Tax { get; set; }
        ...
        public double NonElec_ZD_Premium { get; set; }
        public double Bifuel_ZD_Premium { get; set; }
        public double Trailer_ZD_Premium { get; set; }
        public double Trailer_OD_Premium { get; set; }
        public double Trailer_TP_Premium { get; set; }
        public double Electical_Acc_Premium { get; set; }
        public double NonElectical_Acc_Premium { get; set; }
        public double LimitedtoOwnPremises_OD_Premium { get; set; }
        public double LimitedtoOwnPremises_TP_Premium { get; set; }
        ...
        public double NonElec_InclusionofIMT23_Premium { get; set; }
        public double BiFuel_InclusionofIMT23_Premium { get; set; }
        public double Trailer_InclusionofIMT23_Premium { get; set; }
        public double OtherLoading_Premium { get; set; }
        public double OtherDiscount_Premium { get; set; }
        public double AntiTheftDisc_Premium { get; set; }
        public double HandicapDisc_Premium { get; set; }
        public double NCBBonusDisc_Premium { get; set; }
        public double HighTonnageLoading_Premium { get; set; }
        public double FPP_Premium { get; set; }
        public double NFPP_Premium { get; set; }
        public double BreakIN_Premium { get; set; }
        public double SGST_Premium { get; set; }
    ...
    public class Resp_MISD
    {
        ...
        public double BiFuel_InclusionofIMT23_Premium { get; set; }
        public double Trailer_InclusionofIMT23_Premium { get; set; }
        public double OverTurningLoading_Premium { get; set; }
        public double OtherLoading_Premium { get; set; }
        public double OtherDiscount_Premium { get; set; }
        public double AntiTheftDisc_Premium { get; set; }
        public double HandicapDisc_Premium { get; set; }
    ...
    public class Resp_Payment_Details
    {
