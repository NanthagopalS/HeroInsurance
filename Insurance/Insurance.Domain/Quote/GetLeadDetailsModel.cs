...
public class GetLeadDetailsModel
{
    ...
    public string PrevPolicyNCBId { get; set; }
    ...
    public List<LeadPreviousCoverDetails> LeadPreviousCoverDetails { get; set; } = new();
...
public class LeadPreviousCoverDetails
{
    public string CoverId { get; set; }
    public string CoverFlag { get; set; }
