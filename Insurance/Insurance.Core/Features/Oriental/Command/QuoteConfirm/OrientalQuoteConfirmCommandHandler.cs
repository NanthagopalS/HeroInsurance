...
namespace Insurance.Core.Features.Oriental.Command.QuoteConfirm;

public class OrientalQuoteConfirmCommand : QuoteConfirmRequestModel, IRequest<HeroResult<QuoteConfirmDetailsResponseModel>>
{
}
public class OrientalQuoteConfirmCommandHandler : IRequestHandler<OrientalQuoteConfirmCommand, HeroResult<QuoteConfirmDetailsResponseModel>>
{
    ...
    public OrientalQuoteConfirmCommandHandler(IQuoteRepository quoteRepository, 
        IMapper mapper, 
    ...
    public async Task<HeroResult<QuoteConfirmDetailsResponseModel>> Handle(OrientalQuoteConfirmCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            var result = await _orientalRepository.QuoteConfirmDetails(quoteResponseDB, quoteConfirmCommand, cancellationToken);
    ...
    private bool DoesSAODInsurerIsSame(OrientalQuoteConfirmCommand request)
    {
    ...
    private bool DoesTPInsurerIsSame(OrientalQuoteConfirmCommand request)
    {
        return !request.IsBrandNewVehicle &&
