...
public class GetRelianceQuery : QuoteBaseCommand, IRequest<HeroResult<QuoteResponseModel>>
{

}

public class GetQuoteQueryHandler : IRequestHandler<GetRelianceQuery, HeroResult<QuoteResponseModel>>
{
    ...
    public GetQuoteQueryHandler(IRelianceRepository relianceRepository, IOptions<RelianceConfig> options, IInsurerCheck insurerCheck, IQuoteRepository quoteRepository)
    {
    ...
    public async Task<HeroResult<QuoteResponseModel>> Handle(GetRelianceQuery request, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            var quoteData = await _relianceRepository.GetQuote(request, cancellationToken);
