...
-- =============================================        
CREATE    PROCEDURE [dbo].[Identity_UpdatePersonalDetail1]         
(     
 @UserId Varchar (100),  
...
BEGIN        
 ...
 BEGIN        
   ...
   Set AddressLine1 = @AddressLine1, AddressLine2 = @AddressLine2, Pincode = @Pincode, CityId = @City, StateId = @State  
   where UserId = @UserId  
   ...
   IsSelling = @IsSelling,  
   InsuranceSellingExperienceRangeId = @SellingExperience, AlternateContactNo = @AlternateNumber, NOCAvailable = @NOCAvailable  
   where UserId = @UserId  
