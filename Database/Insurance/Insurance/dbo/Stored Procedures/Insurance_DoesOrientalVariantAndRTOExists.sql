-- EXEC [dbo].[Insurance_DoesIFFCOVariantAndRTOExists] 'F5D1533B-F19E-48D7-9DD8-45B554FA08C1', 'F20CB3D5-E3C6-4C8A-BDD0-DD4E6A190F18'
CREATE     PROCEDURE [dbo].[Insurance_DoesOrientalVariantAndRTOExists]
...
BEGIN
	BEGIN TRY
		...
		FROM MOTOR.Oriental_RTOMaster WITH(NOLOCK) 
		WHERE RTOId = @RTOId)
		BEGIN
			SET @IsRTOExists = 1 
		END
		...
		FROM MOTOR.Oriental_VehicleMaster WITH(NOLOCK) 
